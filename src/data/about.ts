...
const rawCommands = [
    ...
    },
    {
        ...
        output: {
            ...
            info: [
                { label: "Name", value: SITE.owner },
                { label: "Role", value: "DevOps & Cloud Engineer" },
                {
                    label: "Experience",
                    value: "3+ years building resilient systems",
                },
                {
                    label: "DevOps stack",
                    value: "CI/CD, GitHub Actions, Nginx, Linux servers",
                },
                {
                    label: "Cloud",
                    value: "AWS, Vercel, self-hosted infrastructure",
                },
                {
                    label: "Kubernetes",
                    value: "clusters, deployments, services, ingress",
                },
                {
                    label: "Docker",
                    value: "containers, compose, images, registries",
                },
                {
                    label: "Linux",
                    value: "Ubuntu, shell automation, hardening",
                },
                {
                    label: "Skills",
                    value: "TypeScript, Python, networking, security, automation",
                },
                { label: "Contact", value: `${SITE.email} | ${SITE.phone}` },
            ],
        },
    },
    {
