...
export async function AppShell({
    ...
    return (
        <div
            className={cn(
                // Raise the shell above the fixed decorative background layers
                // so page content always paints cleanly on top of the canvas.
                "relative isolate z-30 flex min-h-[100svh] flex-col",
                className,
            )}
        >
            {navigation ?? (
