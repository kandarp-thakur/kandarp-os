...
export function ContainerFleet({ containers, className }: ContainerFleetProps) {
    ...
    return (
        ...
        >
            ...
            {/* Container rows — the fleet. Keep the server-rendered rows visible
                before hydration; an opacity: 0 initial state can leave the
                entire fleet permanently hidden if client JavaScript is delayed
                or fails to hydrate. */}
