...
import { AboutOutputView } from "@features/about/components/AboutOutputView";
...
import type { AboutOutput } from "@packages/types/about";
    ...
    return (
        <div
            className={cn(
                ...
                "terminal-surface relative isolate z-10 flex flex-col overflow-hidden rounded-xl",
