...
import type { SafeSettings } from "@backend/schemas/types";

export default function AdminSettingsPage() {
    const [form, setForm] = useState<SafeSettings | null>(null);
    ...
    /* ── Patch helpers ─────────────────────────────────────────────────── */
    const patch = (p: Partial<SafeSettings>) =>
    ...
    return (
        <>
            <AdminPageHeader
                title="Settings"
                description="Manage your site configuration and branding. Integration credentials are managed separately."
            />
                ...
                <div className={cardClass}>
                    ...
                    <div className="space-y-2">
                        {form.notificationEmails.map((email, idx) => (
                            <div
                                // Empty and duplicate draft addresses are valid while editing.
