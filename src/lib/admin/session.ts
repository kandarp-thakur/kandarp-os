...
import type { AdminSession, AdminRole } from "@/lib/admin/auth";
import { create, list } from "@/lib/admin/repo";
...
export function recentActivity(limit = 8): ActivityLog[] {
    return list<ActivityLog>("activityLogs")
