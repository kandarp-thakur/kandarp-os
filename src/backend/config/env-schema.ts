 ...
 *   • `ADMIN_JWT_SECRET` / `AUTH_SECRET` / `CONTACT_HASH_SECRET` ≥ 32 bytes.
...
const envSchema = z.object({
    ...
    /** Independent key material for AES-256-GCM managed-secret encryption. */
    MANAGED_SECRETS_KEY: secret32.optional(),
    ...
    // ── Contact / email ─────────────────────────────────────────────────
    CONTACT_HASH_SECRET: secret32.optional(),
