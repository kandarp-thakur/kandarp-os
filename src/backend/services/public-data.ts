...
export async function getPublicProjects(): Promise<Container[]> {
    ...
    const { rows } = await query<Project>("projects", {
...
export async function getPublicExperience(): Promise<Deployment[]> {
    ...
    const { rows } = await query<Experience>("experience", {
        includeArchived: false,
        sort: "displayOrder",
        order: "asc",
        page: 1,
...
export async function getPublicSkills(): Promise<SkillNode[]> {
    ...
    const { rows } = await query<Skill>("skills", {
        includeArchived: false,
        sort: "displayOrder",
        order: "asc",
        page: 1,
...
export async function getPublicInfraNodes(): Promise<InfraNode[]> {
    ...
    const { rows } = await query<AdminInfraNode>("infraNodes", {
        includeArchived: false,
        sort: "displayOrder",
        order: "asc",
        page: 1,
...
export async function getPublicAwards(): Promise<Achievement[]> {
    ...
    const { rows } = await query<Award>("awards", {
        includeArchived: false,
        sort: "displayOrder",
        order: "asc",
        page: 1,
...
export async function getPublicBlogPostBySlug(
    ...
    const rows = await list<AdminBlogPost>("blogPosts");
