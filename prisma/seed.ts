...
const ALL_PERMISSIONS = [
    ...
    },
    {
        ...
        description: "View integration and managed-secret metadata.",
    },
    {
        name: "integrations:write",
        description: "Configure integrations and replace managed secrets.",
    },
    {
        name: "api-keys:read",
        description: "View API credential metadata.",
    },
    {
        name: "api-keys:write",
        description: "Create, update, and revoke API credentials.",
    },
    { name: "analytics:read", description: "View analytics and traffic data." },
    { name: "inbox:read", description: "View contact inbox submissions." },
    {
        name: "inbox:write",
        description: "Update contact submission status and reply workflow.",
    },
    {
        name: "inbox:delete",
        description: "Permanently delete contact submissions.",
    },
